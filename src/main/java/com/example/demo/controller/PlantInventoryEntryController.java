...
import com.example.demo.modles.PlantInventoryEntry;
import com.example.demo.modles.PlantInventoryEntryRepository;
...
public class PlantInventoryEntryController {
    ...
    public String form(Model model){
        model.addAttribute("plants", new PlantInventoryEntry());
